...
// Mock data for Fish department orders
const fishOrders = [
  {
    id: "ORD-001",
...
export default function FishOrders() {
  const [orders, setOrders] = useState(fishOrders)
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="flex space-x-4">
              ...
              <Link href="/fish-orders" className="text-blue-600 font-medium">
                แผนกปลา
              </Link>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900">คำสั่งซื้อแผนกปลา</h2>
              <p className="text-gray-600">จัดการและติดตามคำสั่งซื้อสินค้าปลา</p>
            </div>
          </div>
        </div>
        ...
        <div className="legacy-card">
          <div className="p-4 border-b border-gray-200">
            <h3 className="text-lg font-semibold">คำสั่งซื้อแผนกปลา</h3>
          </div>
                        ...
                        <div className="flex gap-2">
                          ...
                          {nextStatus && (
                            <button
                              ...
                              style={{ padding: "4px 8px", fontSize: "12px", background: "#2563eb" }}
                            >
