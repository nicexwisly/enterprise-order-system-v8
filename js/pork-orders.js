// JavaScript สำหรับหน้า Pork Orders - ไม่ใช้ localStorage
document.addEventListener("DOMContentLoaded", () => {
  var searchInput = document.getElementById("searchInput")
  var statusFilter = document.getElementById("statusFilter")
  var porkOrdersTableBody = document.getElementById("porkOrdersTableBody")
  ...
  function loadData() {
    porkOrders = window.OrderData.getOrdersByDepartment("Pork")
    filteredOrders = porkOrders.slice()
  ...
  function updateStats() {
    var stats = window.OrderData.getDepartmentStats("Pork")

    var newElement = document.getElementById("porkNewOrders")
    var inProcessElement = document.getElementById("porkInProcessOrders")
    var completedElement = document.getElementById("porkCompletedOrders")
  ...
  function filterOrders() {
    ...
    filteredOrders = window.OrderData.searchOrders(searchTerm, "Pork", status)
    renderOrdersTable()
  }

  function renderOrdersTable() {
    if (!porkOrdersTableBody) return

    porkOrdersTableBody.innerHTML = ""
    ...
    if (filteredOrders.length === 0) {
      ...
      porkOrdersTableBody.appendChild(row)
      return
    }
    ...
    for (var i = 0; i < filteredOrders.length; i++) {
      ...
      porkOrdersTableBody.appendChild(orderRow)
    }
  }
  ...
  function createOrderRow(order) {
    ...
    if (nextStatus) {
      ...
      statusBtn.style.background = "#ec4899"
